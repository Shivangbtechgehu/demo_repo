    ...
    <section className="page-shell grid min-h-[calc(100vh-8rem)] place-items-center py-16">
      <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} className="glass-panel w-full max-w-md rounded-3xl p-6 sm:p-8">
        <div className="mb-6 space-y-2">
          ...
          <p className="text-sm text-slate-300">Use any valid email and password to access the protected dashboard.</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-slate-300">
          Don’t have an account? <Link to="/register" className="text-brand-300 hover:text-brand-200">Create one</Link>
        </p>
      </motion.div>
    </section>
  )
